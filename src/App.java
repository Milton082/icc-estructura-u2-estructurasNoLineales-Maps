...
public class App {
    ...
    private static void runEmpleadoExample() {
        ...
        empCtr1.addEmpleado(new Empleado(1, "Luisa", "Developer"));
        empCtr1.addEmpleado(new Empleado(2, "Pedro", "Developer"));
        empCtr1.addEmpleado(new Empleado(3, "Marco", "Analyst"));
        empCtr1.addEmpleado(new Empleado(4, "Laura", "Tester"));
